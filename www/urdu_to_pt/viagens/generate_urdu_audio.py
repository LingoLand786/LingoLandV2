...
def main():
    ...
    lesson_files = [
        'lesson_airport_phrases.html',
        'lesson_market_phrases.html',
        'lesson_medical_phrases.html',
        'lesson_directions_phrases.html',
        'lesson_restaurant_phrases.html'
    ]
    ...
    for lesson_file in lesson_files:
        ...
        lesson_audio_dir = os.path.join(base_audio_dir, os.path.splitext(lesson_file)[0])
